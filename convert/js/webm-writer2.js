...
/**
 * gif video encoder for Google Chrome. This implementation is suitable for
 ...
 * @constructor
 */
let gifWriter = function(ArrayBufferDataStream, BlobBuffer) {
  return function(options) {
    ...
    optionDefaults = {
      ...
      fd: null,      // Node.JS file descriptor to write to instead of buffering
                     // (optional)
      codec: 'VP8',  // Codec to write to gif file
    ...
    /**
     * Write the gif file header to the stream.
     */
    ...
    function addFrameToCluster(frame) {
      ...
      this.complete = function() {
        ...
        return blobBuffer.complete('video/gif');
      };
  ...
  if (typeof module !== 'undefined' && typeof module.exports !== 'undefined') {
    module.exports =
        gifWriter(require('./ArrayBufferDataStream'), require('./BlobBuffer'));
} else {
  self.gifWriter =
      gifWriter(self.ArrayBufferDataStream, self.BlobBuffer);
}
})();
